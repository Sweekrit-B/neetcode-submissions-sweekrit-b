...
class Solution:
    def leastInterval(self, tasks: List[str], n: int) -> int:
        ...
        for task in tasks_enumerate:
            heapq.heappush(run, (-tasks_enumerate[task], task, 0))
        ...
        while len(run) > 0 or len(cooldown) > 0:
            ...
            if run:
                ...
                if priority_elem[0] + 1 != 0:
                    # update and push
                    heapq.heappush(cooldown, (t + n, priority_elem[1], priority_elem[0] + 1))
            ...
            if cooldown:
                ...
                while cooldown and cooldown[0][0] == t:
                    ...
                    # update and push
                    heapq.heappush(run, (next_waiting[2], next_waiting[1], next_waiting[0]))
